...
namespace ContactUsApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<CloudinaryParams>(Configuration.GetSection("CloudinaryParams"));
            services.Configure<OutlookParams>(Configuration.GetSection("OutlookParams"));
